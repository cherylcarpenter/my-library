/**
 * BookPlaceholderIcon - Placeholder icon for books without covers
 */

export default function BookPlaceholderIcon({ className, size = 72 }: { className?: string; size?: number }) {
  return (
    <svg
      viewBox="0 0 256 256"
      width={size}
